const en = {
  ...
  shippers: {
    ...
    activateShipper: "Activate Shipper",
    noShippers: "No shippers available",
    active: "Active",
    inactive: "Inactive",
    firstName: "Shipper Id",
    lastName: "Last Name",
    companyName: "Company Name",
    createSuccess: "Shipper created successfully",
    updateSuccess: "Shipper updated successfully",
    activated: "Shipper activated",
    deactivated: "Shipper deactivated",
    deactivateSuccess: "Shipper deactivated successfully",
    allDeactivated: "All shippers deactivated",
    activate: "Activate",
  },
  trailers: {
    title: "Trailers",
    ...
    assetId: "Asset ID",
    primary: "Primary",
    createSuccess: "Trailer created and assigned successfully",
    updateSuccess: "Trailer assignment updated successfully",
    removeSuccess: "Trailer assignment removed successfully",
    activated: "Trailer activated",
    deactivated: "Trailer deactivated",
  },
  codriver: {
    title: "Co-Driver",
    addCoDriver: "Add Co-Driver",
    activeCoDriver: "Active Co-Driver",
    noCoDriver: "No co-driver assigned",
    selectCoDriver: "Select Co-Driver",
    activate: "Activate",
    deactivate: "Deactivate",
    createSuccess: "Co-driver assigned successfully",
    updateSuccess: "Co-driver assignment updated",
    removeSuccess: "Co-driver assignment removed",
  ...
  driverTeam: {
    ...
    coDriver: "Co-Driver",
    vehicle: "Vehicle",
    concurrencyError: "Cannot switch. Co-driver is currently logged in.",
    requestSuccess: "Team request sent to admin. You'll be notified when team is created.",
    createSuccess: "Team created successfully! You can now activate it.",
    updateSuccess: "Team status updated successfully",
    updateStatus: "Update Team Status",
    currentStatus: "Current Status",
    newStatus: "New Status",
    reasonOptional: "Reason (optional): Why are you changing the team status?",
    reasonPlaceholder: "e.g., End of shift, Starting new route...",
    requestInfo: "Select a co-driver to create a team. The team will be created immediately.",
    noDrivers: "No drivers available",
    notes: "Notes (optional):",
    notesPlaceholder: "e.g., Route 101, Long haul trip...",
    submitRequest: "Submit Request",
    requestTeamHint: "Tap the + button to request a team",
    startDate: "Start",
    selectCoDriver: "Please select a co-driver",
    tabSelectExisting: "Select Existing",
    tabAddNew: "Add New Co-Driver",
    codriverName: "Co-Driver Name",
    codriverNamePlaceholder: "Enter full name",
    codriverLicenseNumber: "License Number",
    codriverLicenseNumberPlaceholder: "Enter license number",
    codriverLicenseState: "License State",
    selectState: "Select state",
    simplifiedFormInfo:
      "Enter co-driver details. System will find existing driver or create new account automatically.",
    nameRequired: "Co-driver name is required",
    licenseNumberRequired: "License number is required",
    licenseStateRequired: "License state is required",
    selectVehicle: "Select vehicle",
  ...
  locationConsent: {
    ...
    permissionDenied:
      "Location permission is required for ELD compliance. Please enable location access in Settings.",
    backgroundPermissionRequired:
      "Background location access is required to maintain accurate logs when the app is closed.",
  },
}
