...
const es: Translations = {
  ...
  common: {
    ...
    logoutMessage:
      "¿Estás seguro de que quieres cerrar sesión? Necesitarás iniciar sesión nuevamente para acceder a la aplicación.",
  },
  welcomeScreen: {
    postscript:
  ...
  shippers: {
    title: "Remitentes",
    addShipper: "Agregar Remitente",
    activateShipper: "Activar Remitente",
    noShippers: "No hay remitentes disponibles",
    active: "Activo",
    inactive: "Inactivo",
    firstName: "ID del Remitente",
    lastName: "Apellido",
    companyName: "Nombre de la Empresa",
    createSuccess: "Remitente creado exitosamente",
    updateSuccess: "Remitente actualizado exitosamente",
    activated: "Remitente activado",
    deactivated: "Remitente desactivado",
    deactivateSuccess: "Remitente desactivado exitosamente",
    allDeactivated: "Todos los remitentes desactivados",
    activate: "Activar",
  },
  trailers: {
    title: "Remolques",
    ...
    active: "Activo",
    inactive: "Inactivo",
    name: "Nombre del Remolque",
    assetId: "ID del Activo",
    primary: "Principal",
    createSuccess: "Remolque creado y asignado exitosamente",
    updateSuccess: "Asignación de remolque actualizada exitosamente",
    removeSuccess: "Asignación de remolque eliminada exitosamente",
    activated: "Remolque activado",
    deactivated: "Remolque desactivado",
  },
  codriver: {
    title: "Copiloto",
    addCoDriver: "Agregar Copiloto",
    activeCoDriver: "Copiloto Activo",
    noCoDriver: "No hay copiloto asignado",
    selectCoDriver: "Seleccionar Copiloto",
    activate: "Activar",
    deactivate: "Desactivar",
    createSuccess: "Copiloto asignado exitosamente",
    updateSuccess: "Asignación de copiloto actualizada",
    removeSuccess: "Asignación de copiloto eliminada",
    currentlyActive: "Actualmente Activo",
  },
  driverTeam: {
    title: "Equipo de Conductores",
    activeTeam: "Equipo Activo",
    noTeam: "No hay equipo asignado",
    requestTeam: "Solicitar Equipo",
    activate: "Activar Equipo",
    ...
    coDriver: "Copiloto",
    vehicle: "Vehículo",
    concurrencyError: "No se puede cambiar. El copiloto está actualmente conectado.",
    requestSuccess:
      "Solicitud de equipo enviada al administrador. Serás notificado cuando se cree el equipo.",
    createSuccess: "¡Equipo creado exitosamente! Ahora puedes activarlo.",
    updateSuccess: "Estado del equipo actualizado exitosamente",
    updateStatus: "Actualizar Estado del Equipo",
    currentStatus: "Estado Actual",
    newStatus: "Nuevo Estado",
    reasonOptional: "Razón (opcional): ¿Por qué estás cambiando el estado del equipo?",
    reasonPlaceholder: "ej., Fin de turno, Iniciando nueva ruta...",
    requestInfo: "Selecciona un copiloto para crear un equipo. El equipo se creará inmediatamente.",
    noDrivers: "No hay conductores disponibles",
    notes: "Notas (opcional):",
    notesPlaceholder: "ej., Ruta 101, Viaje de larga distancia...",
    submitRequest: "Enviar Solicitud",
    requestTeamHint: "Toca el botón + para solicitar un equipo",
    startDate: "Inicio",
    selectCoDriver: "Por favor selecciona un copiloto",
    tabSelectExisting: "Seleccionar Existente",
    tabAddNew: "Agregar Nuevo Copiloto",
    codriverName: "Nombre del Copiloto",
    codriverNamePlaceholder: "Ingresa el nombre completo",
    codriverLicenseNumber: "Número de Licencia",
    codriverLicenseNumberPlaceholder: "Ingresa el número de licencia",
    codriverLicenseState: "Estado de la Licencia",
    selectState: "Seleccionar estado",
    simplifiedFormInfo:
      "Ingresa los detalles del copiloto. El sistema encontrará un conductor existente o creará una nueva cuenta automáticamente.",
    nameRequired: "El nombre del copiloto es requerido",
    licenseNumberRequired: "El número de licencia es requerido",
    licenseStateRequired: "El estado de la licencia es requerido",
    selectVehicle: "Seleccionar vehículo",
    vehicleRequired: "El vehículo es requerido",
