...
export function useAnalytics(screenName?: string) {
  ...
  const trackButtonClick = useCallback(
    (buttonName: string, buttonLocation: string, screenName?: string) => {
  ...
  return {
    ...
    logFuelPurchaseCreateAttempt:
      analyticsService.logFuelPurchaseCreateAttempt.bind(analyticsService),
    logFuelPurchaseCreateSuccess:
      analyticsService.logFuelPurchaseCreateSuccess.bind(analyticsService),
    ...
    // Sync methods
    logLocationBatchUploadAttempt:
      analyticsService.logLocationBatchUploadAttempt.bind(analyticsService),
    logLocationBatchUploadSuccess:
      analyticsService.logLocationBatchUploadSuccess.bind(analyticsService),
    logLocationBatchUploadFailure:
      analyticsService.logLocationBatchUploadFailure.bind(analyticsService),
