...
import { hosApi, useDailyLogs, useCertifyHOSLog, useCertifyAllUncertifiedLogs, useHOSClock, useHOSLogs } from "@/api/hos"
...
export const LogsScreen = () => {
  ...
  const handleCertifyAllUncertifiedLogs = async () => {
    try {
      ...
      toast.success(`All ${countBeforeCertification} uncertified log${countBeforeCertification !== 1 ? 's' : ''} have been certified successfully`)
    } catch (error: any) {
    ...
    <View style={styles.container}>
      ...
      >
          ...
          <Modal
            ...
            transparent
            animationType="fade"
            onRequestClose={() => !certifyAllUncertifiedMutation.isPending && setShowCertifyAllModal(false)}
          >
            <View style={styles.modalOverlay}>
              <View style={[styles.modalContent, { backgroundColor: colors.cardBackground }]}>
                ...
                <Text style={[styles.modalSubtitle, { color: colors.textDim }]}>
                  You are about to certify {uncertifiedLogsCount} uncertified log{uncertifiedLogsCount !== 1 ? 's' : ''} for {selectedDate.toLocaleDateString()}.
                ...
                <View style={styles.modalButtons}>
                  ...
                  <View style={styles.modalButton}>
                    <LoadingButton
                      title={certifyAllUncertifiedMutation.isPending ? "Certifying..." : "Certify All"}
