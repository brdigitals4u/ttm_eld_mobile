...
export default function ProfileScreen() {
  ...
  const displayStatus = currentStatus
    ...
    : currentHOSStatus?.current_status
      ? formatStatus(currentHOSStatus.current_status)
      : "OFF DUTY"
          ...
          >
            ...
            <Animated.View style={headerAnimatedStyle}>
              ...
              >
                ...
                <View style={styles.headerBadge}>
                  <Award size={16} color={colors.cardBackground} />
            ...
            <ElevatedCard style={styles.section}>
              ...
              <LoadingButton
                ...
                onPress={() =>
                  toast.info("Please contact your administrator to edit your profile.", 2000)
                }
                variant="primary"
            ...
            <ElevatedCard style={styles.section}>
              ...
              <InfoCard
                icon={<User size={20} color={colors.palette.primary600} />}
              ...
              <ElevatedCard style={styles.section}>
                  ...
                  <View style={styles.compactEldRow}>
                    <View style={styles.compactEldIcon}>
                      {driverProfile.eld_ym_enabled ? (
                        ...
                        <View style={styles.disabledIcon}>
                          <Truck size={18} color={colors.textDim} />
                        </View>
                      )}
                    </View>
                ...
                {(() => {
                  const resolvedEldIdRaw =
                    ...
                    (typeof driverProfile?.eld_device_id === "string"
            ...
            {currentHOSStatus && (
              <ElevatedCard style={styles.section}>
                ...
                />
                <InfoCard
                  icon={<TrendingUp size={20} color={colors.tint} />}
                ...
                />
                <InfoCard
                  icon={<TrendingUp size={20} color={colors.palette.primary600} />}
            ...
            {/* Violations */}
            {(unresolvedViolations.length > 0 || driverProfile?.violations_count !== undefined) && (
              <ElevatedCard style={styles.section}>
                <View style={styles.sectionHeader}>
                ...
                {unresolvedViolations.length > 0 && (
                  ...
                  >
                    ...
                    <View style={styles.violationContent}>
                      <Text style={[styles.violationTitle, { color: colors.error }]}>
                        Active Violations
                      </Text>
