        ...
        try {
          ...
          if (loginData.user && loginData.token) {
            ...
            console.log(
              ...
              loginData.token ? "Token exists" : "No token",
            )
            ...
            userData = {
              ...
              name:
                loginData.user.driver_profile?.name ||
              ...
              timezone:
                loginData.user.driver_profile?.timezone ||
                loginData.user.organization_settings?.timezone,
              locale:
                loginData.user.driver_profile?.locale ||
                loginData.user.organization_settings?.locale,
              ...
              drivingTimeRemaining:
                loginData.user.hos_status?.time_remaining?.driving_time_remaining ||
                loginData.user.hos_status?.driving_time_remaining,
              onDutyTimeRemaining:
                loginData.user.hos_status?.time_remaining?.on_duty_time_remaining ||
                loginData.user.hos_status?.on_duty_time_remaining,
              cycleTimeRemaining:
                loginData.user.hos_status?.time_remaining?.cycle_time_remaining ||
                loginData.user.hos_status?.cycle_time_remaining,
              // Vehicle-related custom attributes
            ...
            console.log(
              ...
              organizationSettings ? "Available" : "Not available",
            )
          } else {
    ...
    }),
    {
      ...
      onRehydrateStorage: () => (state) => {
        ...
        if (state) {
          console.log(
            "👤 Restored User:",
            state.user ? `${state.user.firstName} ${state.user.lastName}` : "None",
          )
          ...
          console.log(
            "🚛 Restored Vehicle Assignment:",
            state.vehicleAssignment ? "Available" : "None",
          )
          console.log("🚗 Restored Vehicle Info:", state.vehicleInfo ? "Available" : "None")
          console.log(
            "🏢 Restored Organization Settings:",
            state.organizationSettings ? "Available" : "None",
          )
...
export const useAuth = () => {
  ...
  React.useEffect(() => {
    if (isFirstRender.current) {
      ...
      console.log(
        "  👤 User:",
        store.user ? `${store.user.firstName} ${store.user.lastName}` : "None",
      )
