    ...
    <View style={[styles.container, { backgroundColor: isDark ? colors.cardBackground : "#fff" }]}>
      ...
      <View style={[styles.header, { backgroundColor: colors.tint }]}>
        ...
        <View style={styles.driveTimeContainer}>
          ...
          <Text style={styles.driveTimeValue}>{(totalHours["DRIVING"] || 0).toFixed(1)}h</Text>
        </View>
      </View>
      ...
      <View style={styles.chartContainer}>
        <LineChart
          ...
          style={styles.chart}
          segments={3} // 3 intervals → 4 categories
          ...
          {Object.entries(statusConfig).map(([key, config]: any) => (
            <View key={key} style={styles.legendItem}>
              ...
              <View style={styles.legendText}>
                <Text style={[styles.legendLabel, { color: colors.text }]}>{config.label}</Text>
