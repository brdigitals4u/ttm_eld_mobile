...
const StatusButton = ({ status, label, isActive, onPress, icon }: {
  status: string;
  label: string;
  isActive: boolean;
  onPress: () => void;
    ...
    >
      ...
      <View style={[styles.statusButtons, { opacity: canUpdateStatus() ? 1 : 0.5 }]}>
        <StatusButton
          ...
          icon={<Truck size={20} color={currentStatus === 'driving' ? (isDark ? '#000' : '#fff') : '#10B981'} />}
        />
        ...
        <StatusButton
          ...
          icon={<Briefcase size={20} color={currentStatus === 'onDuty' ? (isDark ? '#000' : '#fff') : '#F59E0B'} />}
        />
        ...
        <StatusButton
          ...
          icon={<Coffee size={20} color={currentStatus === 'offDuty' ? (isDark ? '#000' : '#fff') : '#3B82F6'} />}
        />
        ...
        <StatusButton
          ...
          icon={<Bed size={20} color={currentStatus === 'sleeperBerth' ? (isDark ? '#000' : '#fff') : '#6366F1'} />}
        />
        ...
        <StatusButton
          ...
          icon={<User size={20} color={currentStatus === 'personalConveyance' ? (isDark ? '#000' : '#fff') : colors.tint} />}
        />
      ...
      <ElevatedCard>
        <View style={styles.hosRow}>
          <Text style={[styles.hosLabel, { color: colors.textDim }]}>
