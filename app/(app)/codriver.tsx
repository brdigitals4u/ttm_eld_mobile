...
import { useCoDriver } from '@/context/codriver-context';
...
export default function CoDriverScreen() {
  ...
  const handleRemoveCoDriver = (id: string, name: string) => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Remove', style: 'destructive', onPress: () => removeCoDriver(id) },
      ]
    );
  };
      ...
      <View style={styles.coDriverHeader}>
        <View style={styles.coDriverInfo}>
          ...
          <View style={styles.coDriverDetails}>
            ...
            <Text style={[styles.coDriverEmail, { color: colors.inactive }]}>
              {item.email}
            </Text>
            <Text style={[styles.coDriverLicense, { color: colors.inactive }]}>
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {activeCoDriver && (
        <Card style={[styles.activeDriverCard, { backgroundColor: colors.success }]}>
